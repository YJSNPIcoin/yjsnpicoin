...
uint256 hashGenesisBlock("0xe3cd3ab655ad807a9efa0a18f49b9e097445c3240ef593acd0abfcd0312b4140");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // YJSNPIcoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "YJSNPIcoin Signed Message:\n";
...
{
    // YJSNPIcoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
{
    int64 nSubsidy = 81000000000;

    // Subsidy is cut in half every 840000 blocks, which will occur approximately every 4 years
    nSubsidy >>= (nHeight / 1919810); // YJSNPIcoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 19198; // YJSNPIcoin: 3.5 days
static const int64 nTargetSpacing = 81; // YJSNPIcoin: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // YJSNPIcoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // YJSNPIcoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // YJSNPIcoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xbd35735da58803fee941824b93ef98d12748d79548d04679313be258513e515f");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "YJSNPI is god";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 81000000000;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("f7054ae21be76d6b1c057d5c57e9972a20d28f1eee2242ade168e9ea22cc87466a62ea8820c3ec0754b3fdd3e6d3b7e793fb2ab1db77629f0f1c7f756cc3dd2131") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1508330376;
        block.nBits    = 504365644;
        block.nNonce   = 3850067234;

        if (fTestNet)
        {
            block.nTime    = 1508330376;
            block.nNonce   = 3732122099;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x7d7b2ad16a4c07132097470aacf55014652cfc984c3fff34b1ab3e22645b2010"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // YJSNPIcoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("YJSNPIcoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("YJSNPIcoinMiner : ProcessBlock, block not accepted");
    }
